...
$clien = "SELECT * FROM tbl_cliente";
$clie = $conexion->prepare($clien);
$clie->execute();
$cliente = $clie->fetchAll(PDO::FETCH_ASSOC);
...
<div class="row">
    ...
    <div class="col col-6">
        ...
        <form action="" method="post" id="crearPedido">
            ...
            <div class="mb-2">
                ...
                <select class="form-select" aria-label="Default select example" id="dt_produccion_formula_id ">
                    ...
                    <?php foreach ($formula as $dat) { ?>
                        <option value="<?php echo $dat['clt_codigo'] ?>"><?php echo $dat['clt_usuario_id'] ?></option>
                    <?php } ?>
                </select>
            </div>
