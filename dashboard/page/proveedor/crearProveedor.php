    ...
    <div class="col col-6">
        ...
        <form action="" method="post" id="crearP">
            <div class="mb-2">
                ...
                <input required type="required" class="form-control" name="proveed_nombre" id="proveed_nombre"
            ...
            <div class="mb-2">
                ...
                <input required type="text" class="form-control" name="proveed_telefono" id="proveed_telefono"
                    aria-describedby="helpId" placeholder="  ">
            ...
            <div class="mb-2">
                ...
                <input required type="text" class="form-control" name="proveed_correo" id="proveed_correo"
                    aria-describedby="helpId" placeholder="  ">
